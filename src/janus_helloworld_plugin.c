...
void janus_helloworld_plugin_incoming_rtp(janus_plugin_session *handle, janus_plugin_rtp *packet);
void janus_helloworld_plugin_incoming_rtcp(janus_plugin_session *handle, janus_plugin_rtcp *packet);
void janus_helloworld_plugin_incoming_data(janus_plugin_session *handle, janus_plugin_data *packet);
void janus_helloworld_plugin_slow_link(janus_plugin_session *handle, int mindex, gboolean video, gboolean uplink);
